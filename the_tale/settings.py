...
LOGGING = {
    ...
    'handlers': {
        ...
        'file_game_quest_persons_powers': get_worker_log_file_handler('game_quest_persons_powers'),
    ...
    'loggers': {
        ...
        'the-tale.game.quest_persons_powers': get_worker_logger('game_quest_persons_powers')
